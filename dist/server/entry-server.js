...
const Card = ({ movie }) => {
  ...
  const handleClick = (movieId, movieTitle, genreNames2, rating) => {
  ...
  const genreFinder = () => {
    return genreNames.map((genre) =>
      /* @__PURE__ */ jsx("li", { children: genre }, genre)
    );
  };
  return /* @__PURE__ */ jsxs("div", {
    className: "card",
      ...
      /* @__PURE__ */ jsx("ul", {
        children: movie.genre_ids
          ...
          : movie.genres.map((genre) =>
              /* @__PURE__ */ jsx("li", { children: genre.name }, genre)
            ),
      }),
...
const Header = () => {
  return /* @__PURE__ */ jsx("div", {
    className: "header",
    children: /* @__PURE__ */ jsx("h1", { children: "React Movies" }),
  });
};
function Home() {
  return /* @__PURE__ */ jsxs("div", {
    className: "home-page",
    children: [/* @__PURE__ */ jsx(Header, {}), /* @__PURE__ */ jsx(Form, {})],
  });
}
...
const pages = /* @__PURE__ */ Object.assign({
  ...
  "./pages/AboutUs.jsx": __vite_glob_0_1,
  "./pages/AboutUs2.jsx": __vite_glob_0_2,
  "./pages/AboutUs3.jsx": __vite_glob_0_3,
  "./pages/Home.jsx": __vite_glob_0_4,
  "./pages/MovieDetail.jsx": __vite_glob_0_5,
});
    ...
    children: [
      ...
      /* @__PURE__ */ jsx(Routes, {
        children: routes.map(({ path, component: RouteComp }) => {
          return /* @__PURE__ */ jsx(
            Route,
            { path, element: /* @__PURE__ */ jsx(RouteComp, {}) },
            path
          );
        }),
      }),
