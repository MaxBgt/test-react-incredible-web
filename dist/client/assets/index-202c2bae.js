...
function useSearchParams(defaultInit) {
  ...
  let location = useLocation();
  let searchParams = reactExports.useMemo(() => getSearchParamsForLocation(location.search, defaultSearchParamsRef.current), [location.search]);
  let navigate = useNavigate();
...
const Card = ({ movie }) => {
  const [genreNames, setGenreNames] = reactExports.useState([]);
  ...
  const getGenreNames = () => {
    let genreArray = [];
    for (let i2 = 0; i2 < movie.genre_ids.length; i2++) {
      switch (movie.genre_ids[i2]) {
        case 28:
  ...
  return /* @__PURE__ */ jsxs("div", { className: "card", children: [
    ...
    movie.genre_ids ? /* @__PURE__ */ jsx(
      ...
      {
        className: "btn",
        onClick: () => handleClick(movie.id, movie.title, genreNames, movie.vote_average),
...
const Form = () => {
  ...
  const [sortGoodBad, setSortGoodBad] = reactExports.useState(initialSortGoodBad);
  const [sortByDate, setSortByDate] = reactExports.useState(initialSortByDate);
  const [category, SetCategory] = reactExports.useState(initialCategory);
  const [rating, setRating] = reactExports.useState(initialRating);
  const [search, setSearch] = reactExports.useState("");
  const [submittedSearch, setSubmittedSearch] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxs("div", { className: "form-component", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "result", children: moviesData == null ? void 0 : moviesData.results.filter((movie) => {
      ...
      if (sortGoodBad === "goodToBad") {
        return b2.vote_average - a2.vote_average;
      } else if (sortGoodBad === "badToGood") {
        return a2.vote_average - b2.vote_average;
      }
      return b2.vote_average - a2.vote_average;
    }).slice(0, 8).sort((a2, b2) => {
      if (sortByDate) {
        if (sortByDate === "oldestToNewest") {
          return new Date(a2.release_date) - new Date(b2.release_date);
        } else if (sortByDate === "newestToOldest") {
          return new Date(b2.release_date) - new Date(a2.release_date);
        }
      }
      return 0;
...
var _loadScript = _interopRequireDefault$1(loadScript);
var _deepmerge$1 = _interopRequireDefault$1(cjs);
...
var _props = props;
var _utils$1 = utils;
var _Player3 = _interopRequireDefault(Player$1);
...
var customPlayers = [];
var createReactPlayer$1 = function createReactPlayer(players, fallback) {
  var _class, _temp;
  return _temp = _class = /* @__PURE__ */ function(_Component) {
    ...
    function ReactPlayer2() {
      ...
      _defineProperty(_assertThisInitialized(_this), "getAttributes", (0, _memoizeOne["default"])(function(url) {
        return (0, _utils$1.omit)(_this.props, SUPPORTED_PROPS);
      }));
...
ReactPlayer$1.createReactPlayer = createReactPlayer$1;
var YouTube = {};
var patterns = {};
...
var createReactPlayer2 = ReactPlayer$1.createReactPlayer;
var Player = YouTube.default;
var youtube2 = createReactPlayer2([{
  key: "youtube",
  canPlay: Player.canPlay,
  lazyPlayer: Player
}]);
const ReactPlayer = youtube2;
const MovieDetail = () => {
